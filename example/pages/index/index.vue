<template>
  <div class="page">
    <div class="page__hd">
      <div class="page__title">Mpvue-WeUI</div>
      <div class="page__desc">Mpvue-WeUI 是基于 mpvue 框架，同微信原生视觉体验一致的基础样式库，为微信小程序量身设计，令用户的使用感知更加统一。</div>
    </div>
    ...
    return {
      list: [
        ...
        },
        {
          ...
          name: '操作反馈',
          open: false,
          pages: ['picker', 'city-picker', 'date-picker', 'actionsheet', 'modal']
        },
        {
          id: 'nav',
          name: '导航相关',
